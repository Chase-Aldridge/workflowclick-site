      ...
      {isGateVisible && !shouldBypass && (
        ...
        >
          ...
          >
            ...
            {/* Headline */}
            <h1 className="text-2xl font-bold text-white sm:text-4xl mb-2 sm:mb-3">
              I am an...
            </h1>
            <p className="text-white/50 mb-4 sm:mb-10 text-base sm:text-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6">
              {options.map((option, i) => (
                <motion.button
                  ...
                  className="group relative rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-8 text-left transition-all duration-200 cursor-pointer"
                  whileHover={{
                ...
                >
                  <div
                    className="mb-2 sm:mb-4 inline-flex h-10 w-10 sm:h-14 sm:w-14 items-center justify-center rounded-xl"
                  ...
                  <div
                    className="mt-2 sm:mt-4 text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity"
                    style={{ color: option.accentColor }}
                  >
                    Continue &rarr;
                  </div>
